    ...
    public class DetallesUsuarioDTO
    {
        ...
        public ViewUsuario ToView ()
        {
            return new ViewUsuario
            {
                ...
                Distrito = Distrito,
                Telefono = Telefono,
                FechaRegistro = FechaRegistro.Value == DateTime.MinValue ? DateTime.Now : FechaRegistro.Value,
                Estado = Estado,
                IDUSUARIOSUP = IDUSUARIOSUP.Value,
                RESPONSABLESUP = RESPONSABLESUP,
                REGION = REGION,
                NOMBRECAMPAÑA = NOMBRECAMPAÑA,
                IdRol = IdRol.Value,
                FechaActualizacion = FechaActualizacion.Value == DateTime.MinValue ? DateTime.Now : FechaActualizacion.Value,
                TipoDocumento = TipoDocumento,
                IdUsuarioAccion = IdUsuarioAccion.Value,
                FechaInicio = FechaInicio.Value == DateTime.MinValue ? DateTime.Now : FechaInicio.Value,
                FechaCese = FechaCese.Value == DateTime.MinValue ? DateTime.Now : FechaCese.Value,
                Correo = Correo
            };
        }
