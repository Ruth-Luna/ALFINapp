...
GO
CREATE TABLE [dbo].[CAMPANASSEPTIEMBRE]
(
...
SELECT
	...
	CASE 
        ...
        ELSE NULL
    END
FROM [dbo].[CAMPANASSEPTIEMBRE] AS B
WHERE NOT EXISTS (
    SELECT 1
...
FROM CAMPANASSEPTIEMBRE
WHERE DNI IS NOT NULL;

DROP TABLE IF EXISTS CAMPANASSEPTIEMBRE;
...
select top 30 * from CAMPANASSEPTIEMBRE
