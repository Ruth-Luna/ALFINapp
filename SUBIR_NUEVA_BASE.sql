...
GO
CREATE TABLE [dbo].[COMPANA2025AGOSTO]
(
...
SELECT
	...
	CASE 
        ...
        ELSE NULL
    END
FROM [dbo].[COMPANA2025AGOSTO] AS B
WHERE NOT EXISTS (
    SELECT 1
...
FROM COMPANA2025AGOSTO
WHERE DNI IS NOT NULL;

DROP TABLE IF EXISTS COMPANA2025AGOSTO;
...
select top 30 * from COMPANA2025AGOSTO
