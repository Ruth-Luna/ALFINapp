    ...
    public async Task<IActionResult> VerificarUsuario(string dni, string password)
    {
        try
        {
            ...
            if (usuarioOculto.Data != null)
            {
                ...
                HttpContext.Session.SetInt32("UsuarioId", getUsuarioCambio.Data.IdUsuario);
                HttpContext.Session.SetInt32("RolUser", getUsuarioCambio.Data.IdRol != null ? getUsuarioCambio.Data.IdRol.Value : throw new Exception("El rol del usuario no está definido. Comuníquese con su Supervisor."));
                HttpContext.Session.SetInt32("CambioUsuario", 1);
                return RedirectToAction("Index", "Home");
            }
